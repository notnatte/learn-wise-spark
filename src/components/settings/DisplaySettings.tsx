...
interface DisplaySettingsProps {
  ...
  textSize: number;
  onPreferenceChange: (key: 'darkMode' | 'offlineMode') => void;
      ...
      <CardContent className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            <Switch 
              ...
              onCheckedChange={() => onPreferenceChange('darkMode')} 
            />
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch 
            ...
            onCheckedChange={() => onPreferenceChange('offlineMode')} 
          />
        </div>
        
        <Button onClick={onSave} className="w-full">Save Display Settings</Button>
      </CardContent>
    </Card>
  );
};
